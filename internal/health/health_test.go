...
// block, while a real Cloud Run client's live percent is never nil — treating
// nil-vs-non-nil as a mismatch would report Progressing forever for an
// otherwise healthy service (diff.Compute has this same guard).
