...
golangci-lint run ./...
govulncheck ./...
nilaway -exclude-errors-in-files internal/notify/slack.go,internal/api/api_test.go,internal/cloudrun/gcp.go,internal/githubapp/githubapp.go,internal/leader/lease.go,cmd/runcd/client.go,web/node_modules ./...
```
